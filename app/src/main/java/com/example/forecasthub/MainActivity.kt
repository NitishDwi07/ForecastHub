...
import com.example.forecasthub.ui.theme.BlueJC
import com.example.forecasthub.ui.theme.DarkBlueJC
import com.example.forecasthub.ui.theme.ForeCastHubTheme
...
fun WeatherScreen(){
    ...
    val apiKey =  "ff7a135b0ea336a6520dc51b8cb8f044"
        ...
        Column (
            ...
            OutlinedTextField(value = city,
                ...
                colors = TextFieldDefaults.colors(
                    focusedContainerColor = _root_ide_package_.androidx.compose.ui.graphics.Color.White,
                    unfocusedContainerColor = BlueJC,
...
fun WeatherCard(label : String, value : String,icon : ImageVector){
    Card (
        ...
        colors = CardDefaults.cardColors(_root_ide_package_.androidx.compose.ui.graphics.Color.White),
